<template>
    <div>
      <UButton
        @click="toggle"
        class="text-white focus:outline-none m-1.5 rounded px-6 py-2 font-medium
         hover:bg-orange-800
              hover:ring-4 hover:ring-orange-900
               hover:opacity-60
      ...
      >
          ...
          <span>
           <Icon name="material-symbols:view-list" class="h-6 w-6 dark:text-black
                text-white" />
          </span>
  ...
  <div class="flex justify-center items-center">
          <div class="p-2">
            <NuxtLink @click="open = false" to="/" class="item  ">
              <UButton class="px-5 py-3 min-w-36 font-extrabold hover:bg-orange-800
              hover:ring-4 hover:ring-orange-900
               hover:opacity-60
               rotate-6 hover:rotate-0
               transition duration-500 ease-in-out
               flex mx-auto justify-center items-center  capitalize"> 
               <Icon name="octicon:project-template-16" class="h-6 w-6 dark:text-black
                text-white" />
              
               <span>Project</span>
               <Icon name="material-symbols:arrow-outward-rounded" class="h-6 w-6 dark:text-black
                text-white" />
                </UButton>
            </NuxtLink>
          </div>
          <div class="p-2">
            <NuxtLink @click="open = false" to="/About" class="item  ">
              ...
              transition duration-500 ease-in-out
               ...
               rotate-6 hover:rotate-0
               flex mx-auto justify-center items-center  capitalize"> 
               <Icon name="material-symbols:android-contacts-outline" class="h-6 w-6 dark:text-black
                text-white" />
            ...
            <NuxtLink @click="open = false" to="/saved" class="item  ">
              ...
              hover:ring-4 hover:ring-orange-900
               ...
               transition duration-500 ease-in-out
                rotate-6 hover:rotate-0
               flex mx-auto justify-center items-center  capitalize">
               <Icon name="tabler:file-cv" class="h-6 w-6 dark:text-black
                text-white" />
